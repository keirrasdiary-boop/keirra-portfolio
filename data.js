...
const PROJECTS = [
  ...
  {
    id:'the-knowledge-hub', tab:'16_The_Knowledge_Hub', cat:'innovation',
    icon:'The_Knowledge_Hub.png',
    date:'May 2026 — Present', status:'complete',
    title:'The Knowledge Hub (formerly Tribal Knowledge Hub)',
    situation:'Tribal knowledge — the undocumented, unwritten information that lives within a specific group of people, things we just know because we\'ve been here, learned it along the way, or figured it out on our own — had no home on our team. No SOP existed, no knowledge base article, and when someone transitioned out, moved to a different department, or simply wasn\'t in the room when that information was shared, it disappeared. That gap showed up daily in repeated Slack questions, inconsistent processes, and teammates who didn\'t feel equipped to execute confidently.',
    action:'I independently conceived, designed, and built The Knowledge Hub from the ground up — a full-stack AI-powered internal knowledge platform where team members can upload short tutorials, how-to guides, step-by-step walkthroughs, and documents on anything relevant to our day-to-day work, functioning as our team\'s own searchable, intelligent resource center, built by us, for us.\n\nWhat began as the Tribal Knowledge Hub has since been rebranded to The Knowledge Hub to better reflect its broader purpose as an inclusive institutional knowledge base open to all Instacart employees — not just our immediate team.\n\nI architected the entire system using AI-assisted vibe coding and the technical skills I gained in my computer technology program at Excelsior University. The platform is built on a modern full-stack architecture, including Supabase for authentication, database, and real-time processing; Netlify for hosting; and Gumloop as the AI orchestration layer. It features Google OAuth restricted to @instacart.com accounts, a database with Row-Level Security, content search and discovery, engagement tracking, personalized user profiles, an admin backend, and built-in feedback and support channels.\n\nThe platform is fully AI-integrated across multiple dimensions. Ask TKH AI — our built-in AI assistant — simultaneously searches the platform\'s own content library, Glean across Instacart\'s internal knowledge ecosystem, and the Salesforce Knowledge Base to return sourced, step-by-step answers to any question in real time. Every video uploaded is automatically transcribed using Groq Whisper, generating a full transcript, AI summary, and step-by-step guide with no manual effort required from the uploader. The platform is connected to Slack, Salesforce, Jira, Glean, Google Drive, Google Docs, Google Sheets, Google Slides, and Atlassian — and a dedicated Knowledge Hub Slack bot has been approved and installed in the Instacart workspace.\n\nThe most significant AI capability is the content harvesting system. When any team member tags #TKH in a Slack message, Salesforce case comment, or Jira ticket, the AI agent automatically reads the content, strips sensitive information, generates a professional knowledge base document, checks for duplicates, and submits it for admin review — eliminating the need for manual uploads entirely. Content that would otherwise disappear into a closed ticket or forgotten Slack thread is now automatically captured, documented, and made searchable for the entire team.\n\nI authored a formal leadership communication to pitch the concept and presented a fully functional demo prototype to my director and management chain.',
    result:'The Knowledge Hub is live at tkh-unlocked.netlify.app, actively ingesting content from Slack, Salesforce, and Jira in real time, and open to all Instacart employees. My Director of Customer Experience, Sapna Mitchell, validated the problem, praised the initiative, and directed managers to formally connect the platform to the organization\'s broader Knowledge Management efforts — positioning it for organization-wide impact. The platform was also submitted as a project for the Instacart AI Buildathon 2026, where it was recognized as a fully AI-integrated solution built and deployed during active business hours.',
    s3:'Continuous improvement & ownership mindset',
    s4:'Determines methods & procedures others can use',
    why:'Independently identifying a systemic knowledge gap, building a production-grade AI-powered technology solution to close it, earning director-level validation and cross-functional sponsorship without being asked, and continuously iterating on it over months to add real AI capabilities — not just features — is the exact combination of ownership, technical depth, and strategic thinking required at Senior level.',
    links:[
      {label:'The Knowledge Hub', url:'https://tkh-unlocked.netlify.app'},
      {label:'The Knowledge Hub Walkthrough', url:'https://drive.google.com/file/d/1pXk99NHIaQpGiWjrWYTinF2q7HfN99R1/view'}
    ]
  },
  {
  ...
  },
  {
    ...
    situation:'While working full-time as a Retail Email Specialist II, I made the deliberate decision to pursue a college degree in Computer Technologies — investing in myself, my craft, and my long-term value to this team, this pillar, and this organization. I did this without slowing down, asking for accommodations, or missing a single performance target.',
    action:'I enrolled at Excelsior University using Instacart\'s Professional Development budget and earned straight A\'s across every course in the program — Technology and Society, Technical Writing, Fundamentals of Programming, Cloud Computing and Virtualization, Overview of Computer Security, Business Data Communications, Hardware and Software Essentials, and the Integrated Technology Assessment capstone. I didn\'t just complete the coursework — I applied every concept directly to real work product in real time, building tools and solutions for the team while studying the technical principles behind them.',
    result:'I graduated in July 2026 with an Associate in Applied Science in Computer Technologies, a 3.92 GPA, and honors — proof that continued education, self-improvement, and high performance are not mutually exclusive. The degree validates the technical foundation behind every tool I have built for this team and positions me as a more capable, more versatile, and more valuable contributor to the pillar and the organization going forward.',
...
const TIMELINE = [
  ...
  {date:'May 2026',     project:'The Knowledge Hub',                       cat:'Innovation',  catColor:'#4FC8FF', s3:'Continuous improvement mindset',           s4:'Determines methods others can use'},
...
const S3_CRITERIA = [
  ...
  {criterion:'Continuous Improvement & Ownership Mindset',
   entries:'The Knowledge Hub (identified gap, built AI-powered solution) · Live Unbatchables Proposal (co-authored) · QA Calibration Proposal (self-initiated)'}
];
...
const S4_CRITERIA = [
  ...
  {criterion:'Determines Methods & Procedures Others Can Use',
   entries:'The Knowledge Hub (live at tkh-unlocked.netlify.app) · FreshClip Extension · Wegmans AI Agent · QA Calibration Reference Guide'},
...
const EVIDENCE = {
  ...
  '16_The_Knowledge_Hub':[
    {file:'evidence/16_The_Knowledge_Hub/16_Tribal_Knowledge_Hub_01.jpg',label:'The Knowledge Hub Leadership Email Thread 1'},
    {file:'evidence/16_The_Knowledge_Hub/16_Tribal_Knowledge_Hub_02.jpg',label:'The Knowledge Hub Leadership Email Thread 2'},
    {file:'evidence/16_The_Knowledge_Hub/16_Tribal_Knowledge_Hub_03.jpg',label:'The Knowledge Hub Leadership Email Thread 3'},
    {file:'evidence/16_The_Knowledge_Hub/16_The_Knowledge_Hub_04.jpg',label:'The Knowledge Hub Platform Screenshot 1 — Login Page'},
    {file:'evidence/16_The_Knowledge_Hub/16_The_Knowledge_Hub_05.jpg',label:'The Knowledge Hub Platform Screenshot 2 — Home / Search & Newest Videos'},
    {file:'evidence/16_The_Knowledge_Hub/16_The_Knowledge_Hub_06.jpg',label:'The Knowledge Hub Platform Screenshot 3 — Video Detail Page'},
    {file:'evidence/16_The_Knowledge_Hub/16_The_Knowledge_Hub_07.jpg',label:'The Knowledge Hub Platform Screenshot 4 — AI-Generated Summary, Step-by-Step Guide & Transcript'},
    {file:'evidence/16_The_Knowledge_Hub/16_The_Knowledge_Hub_08.jpg',label:'The Knowledge Hub Platform Screenshot 5 — User Profile & Engagement Stats'},
    {file:'evidence/16_The_Knowledge_Hub/16_The_Knowledge_Hub_09.jpg',label:'The Knowledge Hub Platform Screenshot 6 — Ask TKH AI'},
    {file:'evidence/16_The_Knowledge_Hub/16_The_Knowledge_Hub_10.jpg',label:'The Knowledge Hub Slack Bot in Instacart Slack Marketplace'},
    {file:'evidence/16_The_Knowledge_Hub/16_The_Knowledge_Hub_11.jpg',label:'#TKH Confirmation Message 1 — Content Submission Received'},
    {file:'evidence/16_The_Knowledge_Hub/16_The_Knowledge_Hub_12.jpg',label:'#TKH Confirmation Message 2 — Content Live on The Knowledge Hub'},
    {file:'icons_processed/The_Knowledge_Hub.png',label:'The Knowledge Hub Logo — Glowing Book on Circuit Board (transparent background)'}
  ],
